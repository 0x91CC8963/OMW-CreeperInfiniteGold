...
- Alternatively, go to your user config (usually under `Documents\My Games\OpenMW\openmw.cfg`), then add:  
  - `data="$PATH_TO/Documents/OMW Mods/CreeperInfiniteGold"` (replacing $PATH_TO with your path)  
